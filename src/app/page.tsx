...
// Icon import pattern from react-icons.github.io
...
export default function Home() {
  ...
  // Referenced some Tailwind classes and my repo 'axeinvest-crypto-tracker-mockup' from a cheatsheet to style this layout.
  return (
